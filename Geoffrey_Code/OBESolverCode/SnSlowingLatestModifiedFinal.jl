...
include("auxFunctionsSnSlowingLatestModifiedFinal.jl");
...
longSpeeds = Float64.(vcat(-0.5, -0.25, 0.25, 0.5, 1:0.5:25, 26:35)); #longitudinal speed for 2d force profile (normalized units v/(gam/k))
...
sidebandFreqs2 = [3.4];#second frequency for stacked EOM configuration
