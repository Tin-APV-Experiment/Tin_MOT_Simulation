...
userSpeeds = [-5,-3.5,-3,-2.5,-2,-1.5,-1,-.6,-.4,-.2,-.1,.1,.2,.4,.6,1,1.5,2,2.5,3,3.5,5]; #RedMOT Setting
...
displacementsInMM = [0.01,0.03,0.08,0.15,0.3,0.5,0.9,1.5,3.0,5.0];
...
userSpeeds = [-4,-3,-2.5,-2,-1.5,-1,-.75,-.5,-.25,.25,.5,.75,1,1.5,2,2.5,3,4].*0.2;
...
if saveData==1
    ...
    folderString = string(parent_dir,"/SnMOT_Data/Red_MOT/",date_str,"/",saveDataFolderTag,"BGradGPerCM", bGradReal,time_str,"Trail",numTrialsPerValueSet)
    if useRandPhase == 1
